...
// on below line we have created the list of markers
    ...
    return Scaffold(
      ...
      onMapCreated: (GoogleMapController controller){
        ...
        myMapController!.setMapStyle(_mapStyle);
            ...
            //   // mapType: MapType.normal,
            //   // markers: markers,
            //   polylines: polyline, markers: Set<Marker>.of(markers),
            //   zoomControlsEnabled: falseس,
            //   initialCameraPosition: _kGooglePlex, //Map widget from google_maps_flutter package
  ...
  Widget buildTextField() {
    String googleApikey = "AIzaSyAuPVmFZkg54S-cfFn9LWAhz_gseok4CKQ";
    GoogleMapController? mapController; //contrller for Google map
    CameraPosition? cameraPosition;
    LatLng startLocation = LatLng(27.6602292, 85.308027);
    String location = "Search Location";
    return Positioned(  //search input bar
        top:10,
        child: InkWell(
            onTap: () async {
